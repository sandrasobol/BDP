...
INSERT INTO obiekty VALUES ('obiekt7', (SELECT ST_Union(a.geom,b.geom) FROM obiekty a,obiekty b 
...
SELECT SUM(ST_AREA(ST_BUFFER(obiekty.geom,5))) pp FROM obiekty WHERE ST_HasArc(obiekty.geom) IS FALSE;